...
func (p *Provider) LogoutRedirectURL() *url.URL {
	return helpers.UrlRoot(p.p.RequestURIF(KeyLogoutRedirectURL, p.publicFallbackURL("oauth2/fallbacks/logout/callback")))
}
...
func (p *Provider) IssuerURL() *url.URL {
	...
	return helpers.UrlRoot(issuerURL)
}

func (p *Provider) LoginURL() *url.URL {
	return helpers.UrlRoot(p.p.URIF(KeyLoginURL, p.publicFallbackURL("oauth2/fallbacks/login")))
}

func (p *Provider) LogoutURL() *url.URL {
	return helpers.UrlRoot(p.p.RequestURIF(KeyLogoutURL, p.publicFallbackURL("oauth2/fallbacks/logout")))
}

func (p *Provider) ConsentURL() *url.URL {
	return helpers.UrlRoot(p.p.URIF(KeyConsentURL, p.publicFallbackURL("oauth2/fallbacks/consent")))
}

func (p *Provider) ErrorURL() *url.URL {
	return helpers.UrlRoot(p.p.RequestURIF(KeyErrorURL, p.publicFallbackURL("oauth2/fallbacks/error")))
}

func (p *Provider) PublicURL() *url.URL {
	return helpers.UrlRoot(p.p.RequestURIF(KeyPublicURL, p.IssuerURL()))
}
