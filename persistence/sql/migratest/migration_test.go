...
import (
	...
	"github.com/driver005/oauth/persistence/sql"
...
func TestMigrations(t *testing.T) {
	...
	for db, c := range connections {
		t.Run(fmt.Sprintf("database=%s", db), func(t *testing.T) {
			...
			// TODO https://github.com/driver005/oauth/issues/1815
