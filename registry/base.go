...
import (
	...
	"github.com/driver005/oauth/helpers/oauth2cors"
...
func (m *RegistryBase) Writer() herodot.Writer {
	if m.writer == nil {
		...
		h.ErrorEnhancer = helpers.ErrorEnhancer
		m.writer = h
	}
	return m.writer
}
...
func (m *RegistryBase) CookieStore() sessions.Store {
	if m.cs == nil {
		...
		//
		// https://github.com/driver005/oauth/pull/2488#discussion_r618992698
		cs.MaxAge(0)
...
func (m *RegistryBase) oAuth2Config() *compose.Config {
	return &compose.Config{
		...
		RedirectSecureChecker:          helpers.IsRedirectURISecure(m.C),
	}
}
...
func (m *RegistryBase) AccessTokenJWTStrategy() jwk.JWTStrategy {
	if m.atjs == nil {
		m.atjs = m.newKeyStrategy(helpers.OAuth2JWTKeyName)
	}
	return m.atjs
}
...
func (m *RegistryBase) OpenIDJWTStrategy() jwk.JWTStrategy {
	if m.idtjs == nil {
		m.idtjs = m.newKeyStrategy(helpers.OpenIDConnectKeyName)
	}
	return m.idtjs
}
